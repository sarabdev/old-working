            ...
            <div className="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
              ...
              >
                ...
                <div className="mt-6 rounded border p-4">
                  ...
                  <input
                  style={{backgroundColor:"black",color:"white", borderColor:"white"}}
                    className="mt-2 w-full rounded-lg border border-white-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 dark:bg-[#40414F] dark:text-neutral-100"
                    type="password"
                    value={
                      pluginKeys
                        .find((p) => p.pluginId === PluginID.GOOGLE_SEARCH)
