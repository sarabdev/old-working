...
export const Chat = memo(({ stopConversationRef }: Props) => {
  ...
  return (
    <div style={{backgroundColor:'black'}} className="relative flex-1 overflow-hidden bg-black dark:bg-[#343541]">
      {!(apiKey || serverSideApiKeyIsSet) ? (
        <div className="mx-auto flex h-full w-[300px] flex-col justify-center space-y-6 sm:w-[600px]">
          ...
          <div style={{color:"white"}} className="text-center text-gray-500 dark:text-gray-400">
            <div className="mb-2">
